...
public class GBFS
{
	public static void main(String[] args)
	{
            ...
            gBestFirstSearch(Drobeta,Bucharest);

            List<Node> path = printPath(Bucharest);

            System.out.println("Traversed Path: " + path);
            System.out.println("Path Cost  : " + (int) Bucharest.g_scores );
}
        ...
        public static List<Node> printPath(Node target)
	{
        ...
        public static void gBestFirstSearch(Node source, Node goal)
	{
            ...
            while( ( !queue.isEmpty() ) && ( !found ) )
            {
                    ...
                    for(Edge e : current.adjacencies)
                    {
                        ...
                        double temp_f_scores = child.h_scores;
